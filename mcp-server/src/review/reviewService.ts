...
const SYSTEM_PROMPT = [
  ...
  '- `rationale` is plain prose. Mention or address real people only when they',
  '  appear in the document or matter context (e.g. a named reviewer the team',
  '  routes comments through); never invent a name, persona, or signature that',
